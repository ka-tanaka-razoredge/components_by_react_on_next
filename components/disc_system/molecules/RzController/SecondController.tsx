...
//console.log('---- fetchFromServer begin ----');
      ...
      if (resource === 'SailingShip' || resourceName === 'sailing_ships') {
        // json5形式でなければresponse.dataはparsed/* [ { id, json, ... } ] */．json5形式だとdataがObject[]ではなくstringとなる．
        ...
        <div className={props.classes}>
          <div style={{ display: 'flex' }} >
            <div>
              ...
              <div style={{ height: `${775}px`, width: `${500}px` }}>
                <Editor
                  ref={textarea}
                  height="100%"
  ...
  <input type='button' value='load' onClick={ (e) => { fetchFromServer(); } } /><br />
              ...
              <div>
                ...
                <div style={{ display: 'flex' }}>
                  ...
                  <button onClick={(e) => { setId(-1); }}>reset id</button>
                </div>
              </div>
              <div>
